...
import { faEdit, faTrash,faCheckCircle,faSpinner } from '@fortawesome/free-solid-svg-icons'
                ...
                <div className="card-header p-3">
                  <h5 className="mb-0">
                    ...
                    <div style={{width:'50%',float:'left',textAlign:'right'}}>  
                      <Example handleChange={props.handleChange} handleAddItems={props.handleAddItems}/>
                    </div>
                 </h5>
                </div>
                  ...
                  <table className="table mb-0">
                    ...
                    <tr className="fw-normal" key={item.id}>
                      ...
                      <td className="align-middle">
                        ...
                        <span style={{cursor:'pointer'}} data-mdb-toggle="tooltip" title="Edit" onClick={()=>editItem(item.title,item.id)}>
